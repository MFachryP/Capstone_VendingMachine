...
def admin_menu(vm):
    ...
    while True:
        ...
        if choice == "1":
            ...
            category = input("Masukkan kategori produk (soda/coffee/water): ")
            item_id = input("Masukkan ID produk: ")
            ...
            item_id = input("Masukkan ID produk yang ingin diperbarui: ")
            name = input("Masukkan nama baru (kosongkan jika tidak ingin mengubah): ") or None
            price = input("Masukkan harga baru (kosongkan jika tidak ingin mengubah): ")
            stock = input("Masukkan stok baru (kosongkan jika tidak ingin mengubah): ")
            price = int(price) if price else None
            stock = int(stock) if stock else None
            vm.update_item(item_id, name, price, stock)
        elif choice == "4":
            item_id = input("Masukkan ID produk yang ingin dihapus: ")
